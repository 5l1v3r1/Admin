...
#Fancy banner :p
print ('''\033[91mPROJECT BY CRASH SYSTEM SQUAD''')
time.sleep(2)
print ('\033[97mThanks to my team')
time.sleep(1)
print ('''\033[93m-Mrs_Ch4N
-minewizard
-</?XML>
-./Throne404
-W.I.M
...
time.sleep(5)
os.system('clear')
print ('''\033[92m______   ______  _______ _______  _     _ _______  ______
|       |_____/  |_____| |______  |_____| |______ |_____/
|_____  |    \_  |     |  _____|  |     | |______ |    \_

Admin finder \033[37mModified by \033[91mTn-Cr4sh \033[93mCrash system squad''')

print ('''\033[97m#############################################
#   Mastah is just illusion! 13 April 2019  #
#############################################''')
try:                                                                        
      	target = target.replace('https://', '') #Removes https://
except:                                                              
	print ('\033[1;31m[-]\033[1;m -u argument is not supplied. Enter python Admin.py -h for help')
	quit()
